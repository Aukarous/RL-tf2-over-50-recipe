...
def visualize_maze_values(q_table, env: gym.Env, isMaze=True, arrow=True):
	...
	if isMaze:
		...
		for i in range(8):
			...
			plt.savefig(f"ch_02/value_iter_{i}.png", bbox_inches="tight")
...
def plot_triangular(left, bottom, right, top, ax=None, triplotkw={}, tripcolorkw={}):
	...
	trip_color = ax.tripcolor(A[:, 0], A[:, 1], Tr, facecolors=C, **tripcolorkw)
	return trip_color
